...
const REGIONS = ['All Regions', 'North America', 'Latin America', 'Europe', 'Middle East', 'Africa', 'Asia', 'Oceania', 'Global'];
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FBF9F5', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <header style={{ background: '#F4C142', padding: '56px 24px 64px', textAlign: 'center', position: 'relative' }}>
        ...
        <h1 className="ft-serif" style={{ fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 900, color: '#fff', margin: '0 0 16px', letterSpacing: -1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}>
          <img src="/favicon.png" alt="" style={{ width: '1.4em', height: '1.4em', borderRadius: '18%' }} />
          The Calendar
        </h1>
